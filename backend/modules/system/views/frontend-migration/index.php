...
use common\models\startsearch\Migration;
use lbmzorx\components\behavior\StatusCode;
use lbmzorx\components\widget\BatchDelete;

/* @var $this yii\web\View */
/* @var $searchModel common\models\startsearch\Migration */
...
str
    ...
    <p>
        <?= Html::a('<i class="fa fa-plus-square"></i> '.Yii::t('app', 'Create Migration'), ['create'], ['class' => 'btn btn-success']) ?>
