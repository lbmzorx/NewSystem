...
use common\models\adminsearch\AdminMessageLog;
use lbmzorx\components\behavior\StatusCode;
use lbmzorx\components\widget\BatchDelete;

/* @var $this yii\web\View */
/* @var $searchModel common\models\adminsearch\AdminMessageLog */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Admin Message Logs');
...
?>
<div class="admin-message-log-index">
...
str
    ...
    <p>
        <?= Html::a('<i class="fa fa-plus-square"></i> '.Yii::t('app', 'Create Admin Message Log'), ['create'], ['class' => 'btn btn-success']) ?>
