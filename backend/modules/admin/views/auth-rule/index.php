...
use common\models\adminsearch\AuthRule;
use lbmzorx\components\behavior\StatusCode;
use lbmzorx\components\widget\BatchDelete;

/* @var $this yii\web\View */
/* @var $searchModel common\models\adminsearch\AuthRule */
...
str
    ...
    <p>
        <?= Html::a('<i class="fa fa-plus-square"></i> '.Yii::t('app', 'Create Auth Rule'), ['create'], ['class' => 'btn btn-success']) ?>
