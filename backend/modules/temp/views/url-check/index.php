...
use common\models\startsearch\UrlCheck;
use lbmzorx\components\behavior\StatusCode;
use lbmzorx\components\widget\BatchDelete;

/* @var $this yii\web\View */
/* @var $searchModel common\models\startsearch\UrlCheck */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Url Checks');
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
               ...
               'attribute'=>'status',
               'filter'=>StatusCode::tranStatusCode(UrlCheck::$status_code,'app'),
...
<div id="status-change-dom" style="display: none;">
    <div style="padding: 10px;">
        ...
        <?php foreach ( UrlCheck::$status_code as $k=>$v):?>           
            <label class="checkbox-inline" style="margin: 5px 10px;">
                <?php
                    $css='warning';
                    if( isset(UrlCheck::$status_css) && isset(UrlCheck::$status_css[$k])){
                        $css = UrlCheck::$status_css [$k];
                    }else{
