...
use common\models\startsearch\ArticleCate;
use lbmzorx\components\behavior\StatusCode;
use lbmzorx\components\widget\BatchDelete;

/* @var $this yii\web\View */
/* @var $searchModel common\models\startsearch\ArticleCate */
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
               ...
               'attribute'=>'status',
               'filter'=>StatusCode::tranStatusCode(ArticleCate::$status_code,'app'),
...
<div id="status-change-dom" style="display: none;">
    <div style="padding: 10px;">
        ...
        <?php foreach ( ArticleCate::$status_code as $k=>$v):?>           
            <label class="checkbox-inline" style="margin: 5px 10px;">
                <?php
                    $css='warning';
                    if( isset(ArticleCate::$status_css) && isset(ArticleCate::$status_css[$k])){
                        $css = ArticleCate::$status_css [$k];
                    }else{
