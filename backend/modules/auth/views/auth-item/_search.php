...
/* @var $model common\models\adminsearch\AuthItem */
...
<div class="auth-item-search search-box">
...
<div class="row">
	...
	<div class="col-lg-2 col-sm-2">
		<?=$form->field($model, 'rule_name',[
            'class'=>\lbmzorx\components\widget\InputAddField::className(),
            'firstContent'=>$model->getAttributeLabel('rule_name'),
            'firstOption'=>['id'=>'icon-show-'.\yii\helpers\StringHelper::basename(get_class($model)).'-rule_name'],
        ])->textInput(['maxlength' => true])
        ->label('');?>
	</div>
	<div class="col-lg-2 col-sm-2">
