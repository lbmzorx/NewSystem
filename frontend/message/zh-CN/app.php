...
//    'Available'=>'启用',
    ...
    'Publish'=>'发表',
    'Do you want to publish this article?'=>'您确定提交该文章？',
    'If you have business inquiries or other questions, please fill out the following form to contact us. Thank you.'=>'如果您有任何问题意见或建议，请填写信息，我们将会尽快联系您的，谢谢。',
    'Contact Us'=>'联系我们',
    'Verification Code'=>'验证码',
    'Submit'=>'提交',
    'Article not Exist!'=>'文章不存在！',
    'Thumbup success cancel!'=>'取消赞成功',
    'Thumbup Success!'=>'点赞成功',
    ...
    'Password reset for {app}'=>'{app}用户重置密码',
    'Activate'=>'激活',
    'user name/mobile/email'=>'用户名/手机号/邮箱',
    'You need activate you account first!'=>'你需要先激活账号',
    'Follow the link below to reset your password:'=>'点击以下链接重置密码',
    'Reset password'=>'重置密码',
    'You need reset you password and remember it.'=>'重置密码并记住它.',
    'Activated Success,now you can login!'=>'重置密码成功，现在可以登录了',
    'New password saved. '=>'已经保存了新的密码',
    ...
    'Home'=>'首页',
    'About'=>'关于',
    'Following Cancel'=>'取消关注',
    'Following'=>'关注',
    'Do you want to canel this following?'=>'您要取消关注该作者？',
    'Following Success!'=>'关注成功',
    'Following Failed!'=>'关注失败！',
    'Can not following yourself'=>'不能关注自己',
    'Following Id'=>'被关注人',
