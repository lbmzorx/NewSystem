    ...
    */
    public function rules()
    {
        return array_merge(parent::rules(),[
            ...
            [['user_id','article_cate_id','sort','remain','auth','thumbup','score','status','page_type','add_time','edit_time','flag_headline','flag_recommend','flag_slide_show','flag_special_recommend','flag_roll','flag_bold','flag_picture','recycle','admin_id'], 'default', 'value' =>0,],
    ...
    */
    ...
    public function behaviors()
    {
        return [
            ...
            'updateTag'=>[
                'class'=>'common\components\behavior\ArticleTag',
            ],
            'aduitSuccessMessage'=>[
                'class'=>'common\components\behavior\BroadCastMessageToFans',
                'eventItems'=>[
                ...
                'jobParams'=>[
                    ...
                    'is_link'=>UserMessage::IS_LINK_YES,
                    'group_type'=>UserMessage::GROUP_TYPE_GROUP,
                    'message_type'=>UserMessage::MESSAGE_TYPE_THUMB_UP,
                    'link'=>function($model){
                        return Url::to(['article/index','id'=>$model->id]);
                    },
            ...
            'aduitFailedMessage'=>[
                'class'=>'common\components\behavior\MessageToUser',
                'eventItems'=>[
                ...
                'jobParams'=>[
                    ...
                    'content'=>function($model){
                        return \yii::t('app','You article of {title} cannot be publish for its content ,please check it!',['title'=>$model->title]);
                    }
                ],
            ],
//            'withOneUser'=>[
...
//            ],
    ...
    public static function groupTags(){
        $data=Tag::find()->select('name')->groupBy('name')->orderBy('frequence')->indexBy('name')->limit(50)->column();
        return $data;
    }
