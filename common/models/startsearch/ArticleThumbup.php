...
use common\models\startdata\ArticleThumbup as DataModel;

/**
 * ArticleThumbup represents the model behind the search form of `ArticleThumbup`.
 */
class ArticleThumbup extends DataModel
