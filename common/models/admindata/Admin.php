...
use Yii;
use common\models\admindatabase\Admin as BaseModelAdmin;

/**
* This is the data class for [[common\models\admindatabase\Admin]].
* Data model definde model behavior and status code.
* @see \common\models\admindatabase\Admin
*/
class Admin extends BaseModelAdmin
{
