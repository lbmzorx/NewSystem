...
use Yii;
use common\models\data\ArticleThumbup as BaseModelArticleThumbup;

/**
* This is the data class for [[common\models\data\ArticleThumbup]].
* Data model definde model behavior and status code.
* @see \common\models\data\ArticleThumbup
*/
