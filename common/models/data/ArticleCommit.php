...
use Yii;
use common\models\data\ArticleCommit as BaseModelArticleCommit;

/**
* This is the data class for [[common\models\data\ArticleCommit]].
* Data model definde model behavior and status code.
* @see \common\models\data\ArticleCommit
*/
